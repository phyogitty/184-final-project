...
void main() {
    ...
    float dU = (h(v_uv + vec2(1/u_texture_4_size[1], 0.0)) - h(v_uv)) * u_height_scaling * u_normal_scaling;
    float dV = (h(v_uv + vec2(0.0, 1/u_texture_4_size[0])) - h(v_uv)) * u_height_scaling * u_normal_scaling;
    ...
    float p = 10.0;
    float k_a = 0.2, k_d = 0.2, k_s = 0.4;
    vec4 i_a = vec4(0.59, 0.29, 0.0, 0.0);		// leather

...
void main() {
    ...
    float dU = (h(v_uv + vec2(1/u_texture_3_size[0], 0.0)) - h(v_uv)) * u_height_scaling * u_normal_scaling;
    float dV = (h(v_uv + vec2(0.0, 1/u_texture_3_size[1])) - h(v_uv)) * u_height_scaling * u_normal_scaling;

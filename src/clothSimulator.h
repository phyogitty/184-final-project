...
public:
  ...
  double getAvgSimulationTime() { return simulationTime / simulationSteps; }
  double getSimulationSteps() { return simulation_steps; }
  void setWind(Vector3D windVelocity) { wind = windVelocity; }
